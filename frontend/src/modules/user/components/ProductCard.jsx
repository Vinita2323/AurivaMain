...
export default function ProductCard({ product }) {
  ...
  return (
    <div className="group bg-white rounded-lg sm:rounded-xl border border-[#E8E2D5] hover:border-[#D4AF37] shadow-sm sm:shadow-lg hover:shadow-[0_20px_40px_rgba(0,0,0,0.35),0_0_25px_rgba(212,175,55,0.2)] hover:-translate-y-1.5 sm:hover:-translate-y-2 transition-all duration-500 flex flex-col justify-between relative overflow-hidden text-left">
      ...
      <div className="relative w-full aspect-[1.1] sm:aspect-square overflow-hidden bg-[#FAF7F2]">
      ...
      <div className="p-2 sm:p-4 flex flex-col flex-1">
        ...
        <div className="flex items-center gap-1 mb-0.5 sm:mb-1 text-amber-500">
        ...
        <p className="text-[9px] sm:text-xs text-stone-500 line-clamp-1 mt-0.5 mb-1.5 sm:mb-2.5">
          {product.subtitle || product.tagline || 'Artisanal Natural Seasoning'}
        </p>

        {/* Pricing with Discount Badge */}
        <div className="flex items-center gap-1.5 sm:gap-2 mt-auto mb-1.5 sm:mb-3.5">
        ...
        <div className="flex items-center gap-1 sm:gap-2">
          <button
            ...
            className={`flex-1 py-1.5 sm:py-2.5 px-1.5 sm:px-3 rounded-md sm:rounded-lg text-[8.5px] sm:text-xs font-bold tracking-wider uppercase transition-all duration-300 flex items-center justify-center gap-1 sm:gap-1.5 shadow-xs min-h-[28px] sm:min-h-[40px] ${
              isAdded
          ...
          <Link
            ...
            className="w-7 h-7 sm:w-9 sm:h-9 rounded-md sm:rounded-lg bg-stone-100/90 text-stone-600 hover:text-[#0E2A1B] hover:bg-[#D4AF37]/20 hover:scale-105 flex items-center justify-center transition-all duration-300 shrink-0 shadow-2xs"
            title="Quick View"
          >
