...
export const INITIAL_PRODUCTS_SEED = [
  {
    ...
    isBestseller: true,
    image: "/assets/user/Premium Makhana.jpg",
    gallery: ["/assets/user/Premium Makhana.jpg"],
  ...
  },
  {
    ...
    gallery: ["/assets/user/Types/PeriPeri.jpeg", "/assets/user/Flavored Makhana.jpg"],
  ...
  },
  {
    ...
    badgeType: "popular",
    isBestseller: true,
    image: "/assets/user/Types/CreamOnion.jpeg",
    gallery: ["/assets/user/Types/CreamOnion.jpeg", "/assets/user/Healthy Makhana2.jpg"],
  ...
  },
  {
    ...
    badgeType: "bestseller",
    isBestseller: true,
    image: "/assets/user/Types/Tomato.jpeg",
    gallery: ["/assets/user/Types/Tomato.jpeg", "/assets/user/Flavored Makhana.jpg"],
  ...
  },
  {
    ...
    badgeType: "premium",
    isBestseller: true,
    image: "/assets/user/Classic Makhana.jpg",
    gallery: ["/assets/user/Classic Makhana.jpg", "/assets/user/Types/PeriPeri.jpeg"],
  ...
  },
  {
    ...
    badgeType: "popular",
    isBestseller: true,
    image: "/assets/user/Flavored Makhana.jpg",
    gallery: ["/assets/user/Flavored Makhana.jpg", "/assets/user/Types/Tomato.jpeg"],
  ...
  },
  {
    ...
    badgeType: "new",
    isBestseller: false,
    image: "/assets/user/Healthy Makhana2.jpg",
    gallery: ["/assets/user/Healthy Makhana2.jpg", "/assets/user/Types/CreamOnion.jpeg"],
...
class ProductService {
  ...
  async createProduct(data) {
    ...
    const defaultImage = '/assets/user/Types/PeriPeri.jpeg';
